...
class Reserva
{
    ...
    public function buscaTodos()
    {
        ...
        $sql = "SELECT * FROM reserva INNER JOIN quadra on quadra.ID_QUADRA = reserva.ID_QUADRA INNER JOIN ginasio on ginasio.ID_GINASIO = quadra.ID_GINASIO AND ginasio.ID_PROPRIETARIO = '$this->idpessoa'";
