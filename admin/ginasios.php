...
$v2 = new Pessoa();
$resultado_busca_prop = $v2->BuscaTodosProp();
                ...
                <div class="col-md-12">
                    ...
                    <form method="post" action="actions/cadastra_ginasio.php">
                        ...
                        <div class="row" style="margin-top: 15px; margin-bottom: 15px">
                            ...
                            <div class="col-md-3">
                                <label for="inputIsValid" class=" form-control-label">Proprietario</label>
                                <select class="form-control" id="id_prop" name="id_prop">
                                    <?php
                                    for($i = 0; $i <  count($resultado_busca_prop); $i++){
                                        ?>
                                        <option value="<?php echo $resultado_busca_prop[$i]['ID_PESSOA']; ?>">
                                            <?php echo $resultado_busca_prop[$i]['NOME']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
