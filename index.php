...
<script type="text/javascript" src="verificacpf.js"></script> <!-- Verifica cpf -->
<script type="text/javascript" src="verificacnpj.js"></script><!-- Verifica cnpj -->

<script> <!-- Script faz conversão da mascara nos textbox -->
...
<section class="top-part">
	...
	<source src="videos/video.mp4" type="video/mp4">  <!-- Video fica rodando em 8 segundos fazendo loop iniciando novamente -->
	</video>
</section>
<section class="cd-hero">
	<div class="cd-slider-nav">
		...
		<nav>
			...
			<ul>
				<li class="selected"><a href="#0"><!-- Selected inicia, sendo principal função da pg -->
...
<!--				</a></li>-->
	...
	<!-- Fim Menu -->
	<ul class="cd-hero-slider">  <!-- exibição de slide (video) -->
		<li class="selected">
		<div class="heading">
			<!-- Tela Principal -->
			<h1>SportBoll</h1>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="content first-content">
							<p>A prática de esportes para saúde e bem estar são 
							vários. Principalmente quando se fala em futebol. Esporte 
							que fortalece muito as articulações desenvolve a coordenação 
							motora e o trabalho em equipe. Podendo ser praticado 
							por homens, mulheres e crianças.O site busca melhor 
							controle e acessibilidade para prática do esporte de 
							modo confiável, rápido e eficaz. O objetivo principal 
							deste site é buscar a praticidade e a comodidade de 
							marcar jogos a qualquer hora do dia, verificando a disponibilidade 
							de horários e locais para se jogar futebol. O SportBoll, 
							busca a solução para acabar de vez com as desculpas 
							de “não ter tempo para pesquisar locais apropriados” 
							ou “ ter que ligar para o proprietário da quadra e esperar 
							ele consultar a agenda dele”, entre outras desculpas 
							e atrasos.</p>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="card" style="width: 35rem; border: 1px solid rgba(0, 0, 0, 0.125); border-radius: 3px; padding: 5px">
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <p class="card-text"><?php echo $resultado_busca[$i]['DESCRICAO']; ?></p>
                                                                        <p class="card-text text-primary">R$ <?php echo $resultado_busca[$i]['VALOR']; ?> /h</p>
