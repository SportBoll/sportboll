...
include ("proprietario.class.php");
            $idproprietario = $_SESSION["idproprietario"];
            
            $proprietario = new proprietario("");
            $proprietario ->excluirDados($idproprietario);
           
        ?>
        
        <form action="" method="post">
            <input type="hidden" name="excluir" id="idproprietario" value="<?php echo $idproprietario; ?>"/>
            </form>
